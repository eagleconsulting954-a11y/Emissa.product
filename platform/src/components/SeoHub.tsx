...
export default function SeoHub({ title, description, basePath, eyebrow, entries }:{ title:string; description:string; basePath:string; eyebrow:string; entries:Record<string,SeoEntry> }) {
  return <main className="seoPage">
    <nav className="seoNav"><a className="seoBrand" href="/">EMISSA</a><div><a href="/solutions">Solutions</a><a href="/regulations">Regulations</a><a href="/integrations">Integrations</a><a href="/tools">Tools</a><a href="/resources">Resources</a><a href="/demo">Demo</a></div></nav>
