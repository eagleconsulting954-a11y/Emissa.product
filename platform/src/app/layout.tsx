...
export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  ...
  const websiteSchema={'@context':'https://schema.org','@type':'WebSite',name:'Emissa',url:siteUrl,description:'Supplier compliance infrastructure, regulatory intelligence, product compliance, templates, tools, research and implementation guidance.'};
