...
import { regulatoryStatus } from '@/lib/regulatoryStatus';
import '../../seo.css';
...
export default async function RegulationPage({params}:{params:Promise<{slug:string}>}){const {slug}=await params;const entry=allRegulations[slug as Slug];if(!entry)notFound();return <SeoExpansionPage entry={entry} hubPath="/regulations" hubLabel="Regulatory Intelligence" reviewMeta={regulatoryStatus[slug]}/>;}
